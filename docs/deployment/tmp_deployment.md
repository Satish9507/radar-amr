...
```
python manage.py migrate && python manage.py load_compounds && python manage.py load_pnec_values && python manage.py load_pnec_from_excel ../docs/reference/PNEC_Reference_Table.xlsx && python manage.py load_module_config && python manage.py load_qmra_module_config && python manage.py load_pathogen_profiles && python manage.py load_camri_module_config && python manage.py setup_auth && gunicorn core.wsgi --log-file -
```
